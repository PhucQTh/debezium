...
MySQL - 10.3.38-MariaDB-0ubuntu0.20.04.1-log : Database - acca_qcreport
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`acca_qcreport` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
...
CREATE TABLE `tbl_attachedfiles` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=46678 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=3698 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tbl_checked_history` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=993739 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tbl_ncrqc` (
  ...
  `deleted_date` datetime DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=9817 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tbl_ncrqc_detail` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=MyISAM AUTO_INCREMENT=17900 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tbl_prod_schedule` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=6388 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tbl_sopqc` (
  ...
  `archived_date` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8606 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=1998262 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tbl_sopqc_detail_gravure` (
  ...
  PRIMARY KEY (`id`),
  KEY `sopqc_id` (`sopqc_id`)
) ENGINE=InnoDB AUTO_INCREMENT=183399 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tbl_sopqc_detail_multi` (
  ...
  PRIMARY KEY (`id`),
  KEY `sopqc_id` (`sopqc_id`)
) ENGINE=InnoDB AUTO_INCREMENT=311512 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tbl_sopqc_detail_pallet` (
  ...
  PRIMARY KEY (`id`),
  KEY `sopqc_id` (`sopqc_id`)
) ENGINE=InnoDB AUTO_INCREMENT=83271 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tbl_sopqc_notes` (
  ...
  PRIMARY KEY (`id`),
  KEY `request_note` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15561 DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
CREATE TABLE `tbl_test_result` (
  ...
  `deleted_date` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=25343 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=28011 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=552551 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=59809 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=1512538 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tbl_test_result_lab_detail_multi` (
  ...
  PRIMARY KEY (`id`),
  KEY `sopqc_id` (`test_result_lab_id`)
) ENGINE=InnoDB AUTO_INCREMENT=446084 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tbl_test_result_lab_history` (
  ...
  PRIMARY KEY (`id`),
  KEY `sopqc_id` (`test_result_lab_id`)
) ENGINE=InnoDB AUTO_INCREMENT=128287 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=7291 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=99324 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
) ENGINE=InnoDB AUTO_INCREMENT=2647628 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tbl_test_result_sopqc_detail_multi` (
  ...
  PRIMARY KEY (`id`),
  KEY `sopqc_id` (`test_result_sopqc_id`)
) ENGINE=InnoDB AUTO_INCREMENT=339647 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
